...
function isPointInWeatherEvent(lat: number, lon: number, event: any): boolean {
...
async function applyWeatherPenalties(routeData: any, inputPoints: [number, number][]): Promise<any> {
    try {
